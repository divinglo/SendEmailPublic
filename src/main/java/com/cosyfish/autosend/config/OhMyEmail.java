package com.cosyfish.autosend.config;


import com.cosyfish.autosend.Exception.SendMailException;
...
public class OhMyEmail {
    ...
    public OhMyEmail attachInputStream(ByteArrayInputStream inputstream, String fileName) throws Exception {
        attachments.add(createInputStreamAttachment(inputstream, fileName));
        return this;
    }
    ...
    private MimeBodyPart createInputStreamAttachment(ByteArrayInputStream inputstream, String fileName) throws Exception {
        MimeBodyPart   attachmentPart = new MimeBodyPart();
